...
<div class="wrapper inner-main-title">
	...
	<div class="container">
		<header class="entry-header init-animate">
			<?php
			$single_header_title = $travel_way_customizer_all_values['travel-way-single-header-title'];
	...
	<div id="primary" class="content-area">
		...
		while ( have_posts() ) :
			...
			if ( is_singular( 'attachment' ) ) {
				...
				the_post_navigation(
					array(
						'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link', 'travel-way' ),
					)
				);
