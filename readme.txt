...
Travel Way is a Travel WordPress theme.
...
1. In your admin panel, go to Appearance > Themes and click the Add New button and Search for Travel Way, OR
...
= 1.0.1 =
* Image on screenshot changed
* Prefix changed on some scripts handler
* Added Editor style
...
Travel Way WordPress Theme, Copyright 2016-2019 Acme Themes( acmethemes.com )
Travel Way is distributed under the terms of the GNU GPL
...
Travel Way bundles the following third-party resources:
...
Other Images:
- travel-way-inner-banner1920x600.jpg
