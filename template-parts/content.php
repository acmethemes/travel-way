...
$content_from                     = $travel_way_customizer_all_values['travel-way-blog-archive-content-from'];
$no_blog_image                    = '';
?>
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="content-wrapper">
		<?php
		$thumbnail = $travel_way_customizer_all_values['travel-way-blog-archive-img-size'];
			...
			if ( 'content' == $content_from ) :
				the_content(
					...
					/* translators: %s: Name of current post. */
						wp_kses( __( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'travel-way' ), array( 'span' => array( 'class' => array() ) ) ),
