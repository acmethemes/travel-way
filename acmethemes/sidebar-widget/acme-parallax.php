 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Travel_Way_Feature' ) ) {

	class Travel_Way_Feature extends WP_Widget {
		...
		private function defaults(){
			...
			$defaults = array(
				...
				'sub_title'         => '',
				'bg_image'          => '',
				'button_one_text'   => esc_html__( 'Book Now', 'travel-way' ),
				'button_one_url'    => '',
				'button_two_text'   => esc_html__( 'Learn More', 'travel-way' ),
				'button_two_url'    => ''
			);
			return $defaults;
		}
		...
		function __construct() {
			parent::__construct(
                    ...
                    esc_html__('AT Feature Section', 'travel-way'),
                    /*Widget description*/
                    array(
                            'description' => esc_html__( 'Show Parallax Section.', 'travel-way' )
                    )
			);
		}
		...
		public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'sub_title' ) ); ?>"><?php _e( 'Short Description', 'travel-way' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_one_text' ) ); ?>"><?php esc_html_e( 'Extra Button Text', 'travel-way' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_one_url' ) ); ?>"><?php esc_html_e( 'Button Link Url', 'travel-way' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_two_text' ) ); ?>"><?php esc_html_e( 'Extra Button Text', 'travel-way' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_two_url' ) ); ?>"><?php esc_html_e( 'Button Link Url', 'travel-way' ); ?></label>
			...
			<section id="<?php echo esc_attr( $unique_id ); ?>" class="at-widgets primary-bg <?php echo $bg_image_class; ?> " style="<?php echo esc_attr( $bg_image_style ); ?>">
				<div class="container">
                    ...
                    if( ! empty( $title ) || !empty( $sub_title ) ){
                        ...
                        if( !empty( $sub_title ) ) { ?>
                            <p class="at-subtitle <?php echo $animation;?>"><?php echo wp_kses_post( $sub_title ); ?></p>
                            <?php
                        }
                        echo "</div>";
                    }
	...
	} // Class Travel_Way_Feature ends here
}