 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Travel_Way_Contact' ) ) {

    class Travel_Way_Contact extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                    ...
                    esc_html__('AT Contact Section', 'travel-way'),
                    /*Widget description*/
                    array(
                            'description' => esc_html__( 'Show Contact Section.', 'travel-way' )
                    )
            );
        }
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'shortcode' ) ); ?>"><?php esc_html_e( 'Enter Shortcode', 'travel-way' ); ?>:</label>
                ...
                <small>
                    <?php
                    printf( esc_html__( 'Download contact form 7 from %1$shere%2$s', 'travel-way' ), "<a target='_blank' href='".esc_url( 'https://wordpress.org/plugins/contact-form-7/' )."''>","</a>" );
                    ?>
                </small>
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php esc_html_e( 'Select Page For Contact', 'travel-way' ); ?>:</label>
                <br />
                <small><?php esc_html_e( 'Select page and its title and excerpt will display in the frontend. No need of subpages.', 'travel-way' ); ?></small>
                <?php
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'single_page_content_from' ) ); ?>"><?php _e( 'Page Content From', 'travel-way' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'single_page_content_number' ) ); ?>"><?php _e( 'Number of page words in content', 'travel-way' ); ?>:</label>
                <br/>
                <small>
        ...
        public function update( $new_instance, $old_instance ) {
            ...
            $instance[ 'page_id' ]              = travel_way_sanitize_page( $new_instance[ 'page_id' ] );

	        $content_from_options           = travel_way_content_from();
	        $instance['single_page_content_from']       = travel_way_sanitize_choice_options( $new_instance['single_page_content_from'], $content_from_options, 'content' );
                    ...
                    <div class="container">
                        <div class="row">
	                        ...
	                        if( !empty ( $page_id ) ) :
		                        ...
		                        $contact_page_query = new WP_Query( $travel_way_post_in_page_args );
		                        /*The Loop*/
                                        ...
                                        <div class="col-md-6  <?php echo esc_attr( $animation ); ?>">
                                            <div class="contact-page-content">
                                                ...
                                                if( 0 != $single_page_content_number ){
                                                    travel_way_advanced_content( $single_page_content_number, $single_page_content_from );
                                                }
                                                ?>
                                            </div>
                                        </div>
    ...
    } // Class Travel_Way_Contact ends here
}