    ...
    class Travel_Way_Wc_Feature_Cats extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                ...
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'travel_way_widget_title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'travel_way_widget_title' ) ); ?>" type="text" value="<?php echo esc_attr( $travel_way_widget_title ); ?>" />
            </p>
        ...
        public function widget($args, $instance) {
	        ...
	        if ( !empty( $travel_way_widget_title )){
		        ...
		        echo esc_html( $travel_way_widget_title );
